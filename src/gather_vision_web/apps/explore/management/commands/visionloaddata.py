...
from gather_vision_web.services.data.manage import FixtureManager, DataLoaderManager

from gather_vision_web.services.web.client import DownloadClient
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        pref = "gather_vision_web.services"
        data_loaders = [
